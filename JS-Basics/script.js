...
/*************************************
* Variable Mutation and type coericon 
*/
/*
var firstName = 'John';
var age = 28;
...
switch(job) {
    ...
    case 'instructor':
        ...
        break;
    case 'driver':
        console.log(firstName + ' drive san uber.');
        break;
    case 'designer':
...
if (JohnAvg > MikeAvg && JohnAvg > MaryAvg) {
    console.log('John\'s team has won. With the average score of ' + JohnAvg);
} else if (MikeAvg > JohnAvg && MikeAvg > MaryAvg) {
    console.log('Mike\'s team has won. With the average score of ' + MikeAvg);
} else if (MaryAvg > JohnAvg && MaryAvg > MikeAvg) {
    console.log('Mary\'s team has won. With the average score of ' + MaryAvg);
} else {
...
yearsUntilRetirement(1964, 'Mark');
*/
...
console.log(whatDoYouDo('cook', 'Mike'));
*/
