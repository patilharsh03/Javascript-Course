...
//question.forEach((value, key) => console.log(`This is ${key}, and it's set to
//${value}`));
...
5. Size classification of all streets: tiny/small/normal/big/huge. If the 
size is unknown, the default is normal
